...
Due: [Tuesday, February 14, 2023]{.orange_due}.
...
Your task is to publish a report about whether the U.S. economy does better under Republican control or Democratic control.
You may have prior ideas about this question, but your goal is to provide *data* that answer it.
...
10. Create a report that captures the information you collected during the exercise and summarize your finding(s) in a sentence or two. You may use the simple [report template](report-template.html) as a guide.

## Submit {-}

Print your report and bring it to class with you on **February 21, 2023**.
Please also save a copy of your report as a PDF using the preferred file naming convention for this class: `<lastname>-<firstname>-PSYCH490.002-ex01.docx`, where you substitute your last name for <lastname> and your first name for <firstname>.
