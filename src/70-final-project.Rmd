...
- Project proposal
    - Every student or team must submit a one-page project proposal. If the proposal is submitted on-time ([by Thu March 2]{.orange_due}), the student or team gets 5 extra credit points. If the proposal is submitted late, there is no penalty, but also no extra points. If a student or team does not submit a proposal, there will be a five point penalty.
- Project presentation (optional, but strongly recommended)
...
- Project write-up
    - Every student or team must submit a write-up, [due on May 3, 2023]{.orange_due}.
    - Depending on the format of the project (talk, poster, paper), different written materials may be submitted (slides, poster, etc.).
    - For an in-class talk, submit your talk text or your slides with presenter notes.
    - For a poster, submit a PowerPoint or PDF of your poster.

## Survey {-}

- Please provide us information about your project via this Google Form:

<https://forms.gle/XWFYHcnb3MAV1u4H8>